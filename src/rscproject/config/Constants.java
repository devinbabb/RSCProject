...
public class Constants {
    ...
    public static class GameServer {
         ...
         */
        public static final String SERVER_NAME = "RSCAngel";
        /**
    ...
    public static class IRC {
         ...
         */
        public static final String[][] CHANNELS = {{"#rscproject.staff", "staffonly"}};
        /**
         * Channel for the IRC bot to join
         */
        public static final String NICK = "RSCA_" + (GameServer.MEMBER_WORLD ? "P2P" : "F2P") + "_" + Formulae.Rand(0, 900);
        /**
         * the login/full name thing IRC wants. [NOT NICKNAME]
         */
        public static final String USER = "rsca";
        /**
         ...
         * word, new mask}
         */
        public static final String[][] BANNED_WORDS = {{"stork", "rscangel"}};
    }
