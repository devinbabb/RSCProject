...
import rscproject.gs.core.LoginConnector;
...
public class Server {
	...
	public static void main(String[] args) throws IOException {
		...
		Constants.GameServer.MOTD = "@yel@Welcome to @whi@"
				...
				+ "@yel@ - World @whi@"
				+ (Constants.GameServer.WORLD_NUMBER == 0 ? 2
						: Constants.GameServer.WORLD_NUMBER) + " ("
				+ (Constants.GameServer.MEMBER_WORLD ? "P2P" : "F2P") + ")";
		...
		Logger.println(Constants.GameServer.SERVER_NAME + " ["
				+ (Constants.GameServer.MEMBER_WORLD ? "P2P" : "F2P") + "] "
				+ "Server starting up...");
