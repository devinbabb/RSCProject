...
public final class ClientUpdater implements Processor {
    ...
    public void doMajor() {
        ...
        if (delay > 299)
            Logger.println("updateNpcPositions() is taking longer than it should, exactly " + delay + "ms");
        ...
        delay = System.currentTimeMillis() - now;
        if (delay > 299)
            Logger.println("updatePlayersPositions() is taking longer than it should, exactly " + delay + "ms");
        ...
        delay = System.currentTimeMillis() - now;
        if (delay > 299)
            Logger.println("updateMessageQueues() is taking longer than it should, exactly " + delay + "ms");
