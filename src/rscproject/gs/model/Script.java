...
public class Script {
     ...
     *
     * @param msg - the message
     * @param big - true if large box, false if medium
     */
    ...
    /**
     * War running true or false
     *
     * @return
     */
    public boolean isWarRunning() {
        return World.getWar().isRunning();
    }

    public boolean inATeam() {
        return World.getWar().inBlue(player) || World.getWar().inRed(player);
    }

    public int getTeam() {
        if (World.getWar().inRed(player))
            return 0;
        else
            return 1;
    }
    ...
    public void teleportPlayer() {
        player.teleport(World.getWar().getCoords(player)[0], World.getWar().getCoords(player)[1], true);
    }

    public void joinTeam() {
        World.getWar().joinRandomTeam(player);
    }

    public void leaveTeam() {
        World.getWar().leaveTeam(player);
    }
