...
public class KnightsSword extends Quest {
	 ...
	 * rscproject.gs.external.EntityHandler.getObjectMiningDef(102);
	 * 
	 ...
	 * 
	 * int axeId = -1; for(int id : rscproject.config.Formulae.miningAxeIDs) {
	 ...
	 * 
	 * if(rscproject.config.Formulae.getOre(def, player.getCurStat(14), axeID))
	 * { giveItem(player, ore);
