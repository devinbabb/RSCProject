...
public class PluginHandler {
	...
	public void initPlugins() {
		try {
			try {
				getClassesFromFileJarFile("rscproject.gs.plugins.plugs",
						System.getProperty("user.dir"));
				getClassesFromFileJarFile("rscproject.gs.plugins.plugs.skills",
						System.getProperty("user.dir"));
				getClassesFromFileJarFile("rscproject.gs.plugins.ai",
						System.getProperty("user.dir"));
