...
import rscproject.gs.external.DoorDef;
                            ...
                            case 55: // Mining Guild Door
                                ...
                                if (object.getX() == 150 && object.getY() == 554) { // Champs
                                    ...
                                    if (owner.getSkillTotal() < 600) {
                                        owner.getActionSender().sendMessage("You need a skill total of 600 or more to enter");
                                        return;
                                    }
                                    doDoor();
                                ...
                                if (object.getX() == 372 && object.getY() == 441) { // Heroes
                                    ...
                                    if (owner.getSkillTotal() < 850) {
                                        owner.getActionSender().sendMessage("You need a skill total of 850 or more to enter");
                                        return;
                                    }
                                    doDoor();
