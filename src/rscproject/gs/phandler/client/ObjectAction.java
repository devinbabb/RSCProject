        ...
        Instance.getDelayedEventHandler().add(new WalkToObjectEvent(player, object, false) {
            public void arrived() {
                ...
                try {
                    ...
                    // command);
                    if (object.getID() == 487 && System.currentTimeMillis() - owner.getLastMoved() < 10000) {
                            ...
                            case 1079: // Legends guild gate
                                ...
                                if (owner.getY() <= 550) {
                                    ...
                                    if (owner.getSkillTotal() < 1150) {
                                        owner.getActionSender().sendMessage("You need a skill total of 1150 or more to enter");
                                        return;
                                    }
                                    doGate();
