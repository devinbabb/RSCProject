...
public class PlayerSave {
    ...
    public boolean save() {
        try {
            ...
            Server.db.updateQuery("UPDATE `rsca2_players` SET `combat`=" + combat + ", skill_total=" + skillTotal + ", `x`=" + x + ", `y`='" + y + "', `fatigue`='" + fatigue + "', `haircolour`=" + hairColour + ", `topcolour`=" + topColour + ", `trousercolour`=" + trouserColour + ", `skincolour`=" + skinColour + ", `headsprite`=" + headSprite + ", `bodysprite`=" + bodySprite + ", `male`=" + (male ? 1 : 0) + ", `skulled`=" + skulled + ", `combatstyle`=" + combatStyle + ", `quest_points`=" + questPoints + " WHERE `user`='" + user + "'");
            ...
            Server.db.updateQuery("UPDATE `rsca2_players` SET eventcd='" + getEventCD() + "' WHERE user='" + user + "'");
